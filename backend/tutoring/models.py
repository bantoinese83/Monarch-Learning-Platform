...
class Conversation(TimeStampedModel):
    ...
    student = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='conversations', db_index=True)
    title = models.CharField(max_length=200, blank=True)  # Auto-generated from first message
    subject = models.CharField(max_length=100, blank=True, db_index=True)  # Detected from conversation
