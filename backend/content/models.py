...
class FileSearchStore(TimeStampedModel):
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='file_stores', db_index=True)
...
class EducationalContent(TimeStampedModel):
    ...
    file_search_store = models.ForeignKey(FileSearchStore, on_delete=models.SET_NULL, null=True, blank=True, related_name='contents', db_index=True)
    ...
    parent_content = models.ForeignKey('self', on_delete=models.SET_NULL, null=True, blank=True, related_name='versions')

    uploaded_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='uploaded_content', db_index=True)
...
class ContentMetadata(models.Model):
    ...
    content = models.ForeignKey(EducationalContent, on_delete=models.CASCADE, related_name='custom_metadata', db_index=True)
